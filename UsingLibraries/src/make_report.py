"""Makes report on AG and GDP data
        ...
        * plot_avg_temp - plots average temperature over time for
            selected countries.
        * plot_year_vs_emissions - plots year versus emissions for
            selected countries.
        * plot_gdp_vs_emissions - plots GDP versus emissions for
            selected countries.
